...
function switchTab(newTab){
    if(newTab != oldTab){
        ...
        if(!searchForm.classList.contains("active")){
            ...
            //main pehle search wale tab par tha, ab your weather tab visible karna hain
            searchForm.classList.remove("active");
            userInfoContainer.classList.remove('active');
            notFound.classList.remove('active');
            //ab main your weather tab me aagya hu, toh weather bhi display karna padega, so let's check local storage first
            //for co-ordiantes, if we haved saved them there. 
            getfromSessionStorage();
        }
    }
}
...
function renderWeatherInfo(weatherInfo){
    //firstly, we have to fethic the elements
